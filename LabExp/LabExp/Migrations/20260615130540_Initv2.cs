    ...
    public partial class Initv2 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ScientistsId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TestsTestId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScientistTest", x => new { x.ScientistsId, x.TestsTestId });
                    table.ForeignKey(
                        name: "FK_ScientistTest_AspNetUsers_ScientistsId",
                        column: x => x.ScientistsId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ScientistTest_Tests_TestsTestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScientistTest_TestsTestId",
                table: "ScientistTest",
                column: "TestsTestId");
