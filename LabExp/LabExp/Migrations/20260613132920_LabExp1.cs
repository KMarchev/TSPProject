...
{
    /// <inheritdoc />
    public partial class LabExp1 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LevelPriority = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Clearances_ClearanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Substances", x => x.SubstanceId);
                    table.ForeignKey(
                        name: "FK_Substances_Severities_SeverityId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Subjects_Statuses_StatusId",
                        column: x => x.StatusId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tests_Substances_SubstanceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TestScientistId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TestId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ScientistId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TestScientists", x => x.TestScientistId);
                    table.ForeignKey(
                        name: "FK_TestScientists_AspNetUsers_ScientistId",
                        column: x => x.ScientistId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TestScientists_Tests_TestId",
                        column: x => x.TestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_ClearanceId",
                table: "AspNetUsers",
                column: "ClearanceId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subjects_StatusId",
                table: "Subjects",
                column: "StatusId");

            migrationBuilder.CreateIndex(
                name: "IX_Substances_SeverityId",
                table: "Substances",
                column: "SeverityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tests_SubstanceId",
                table: "Tests",
                column: "SubstanceId");

            migrationBuilder.CreateIndex(
                name: "IX_TestScientists_ScientistId",
                table: "TestScientists",
                column: "ScientistId");

            migrationBuilder.CreateIndex(
                name: "IX_TestScientists_TestId",
                table: "TestScientists",
                column: "TestId");
        }
